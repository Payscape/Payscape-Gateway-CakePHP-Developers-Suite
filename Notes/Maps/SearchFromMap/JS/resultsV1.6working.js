/*
 * this version works, but makes multiple hits to ajax_results, 
 * which slows down the response heavily. 
 * from 3 to 20 and more queries are sent when Zooming out, 
 * or dragging the map. 
 * */
