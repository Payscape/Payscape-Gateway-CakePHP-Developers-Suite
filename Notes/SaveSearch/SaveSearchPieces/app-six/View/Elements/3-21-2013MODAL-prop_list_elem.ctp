<?php $pr = $property['Property']; ?>
    ...
    <li class="vfid_<?= $pr['id']; ?>">
        <div class="cf">
            ...
            <div class="thumb"><?php echo $this->Html->image(ife($property['PropertyImage'][0]['image']['list'], 'list_missing.png'), array('url' => array('controller' => 'properties', 'action' => 'view', 'class' => 'viewbox', $pr['id']))); ?></div>

            <div class="details">
            <h3><?php echo $this->Html->link($pr['title'], array('controller' => 'properties', 'action' => 'view', 'class' => 'viewbox', $pr['id'])); ?></h3>
