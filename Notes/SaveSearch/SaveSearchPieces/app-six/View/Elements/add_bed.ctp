...
<div class="input select add">
	...
	<div class="holder">
		<div class="clone">
			...
			<?php echo $this->Form->select($model.'.NNN.id', ${$var_name}, array('class' => 'narrow')); ?>
	...
	<?php if (isset($this->request->data[$model]) && count($this->request->data[$model])) { ?>
		...
		<div>
			...
			<?php echo $this->Form->select($model.'.'.$key.'.id', ${$var_name}, array('default' => $entry[$model_join][strtolower($model).'_id'], 'class' => 'narrow')); ?>
			<?php echo $this->Html->image('delete.png', array('class' => 'delete', 'title' => 'Delete this '.$model, 'alt' => 'Delete this '.$model)); ?>
		</div>
		...
		<div>
			...
			<?php echo $this->Form->select($model.'.'.($key + 1).'.id', ${$var_name}, array('class' => 'narrow')); ?>
			<?php echo $this->Html->image('delete.png', array('class' => 'delete', 'title' => 'Delete this '.$model, 'alt' => 'Delete this '.$model)); ?>
		</div>
	...
	<?php } else { ?>
		...
		<div>
			...
			<?php echo $this->Form->select($model.'.0.id', ${$var_name}, array('class' => 'narrow')); ?>
			<?php echo $this->Html->image('delete.png', array('class' => 'delete', 'title' => 'Delete this '.$model, 'alt' => 'Delete this '.$model)); ?>
		</div>
