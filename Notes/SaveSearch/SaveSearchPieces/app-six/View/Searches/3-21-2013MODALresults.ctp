...
<?php echo $this->Html->scriptblock('
    var addto_wishlist_url = "'.Router::url(array('controller' => 'wishlists', 'action' => 'add_to_wish')).'";
...
<section class="search-result-page">
    ...
    <?php echo $this->Form->create('Search', array('url' => '/'.$this->request->url)); ?>
        ...
        <div class="search-header">
            ...
            <?= $this->Form->submit('Search', array('div' => 's-btn')) ?>

            <div class="search-tabs">
                <a href="#list-view"  id="list-view" class="first active">List</a>
                <a href="#photo-view" id="photo-view">Photo</a>
                <a href="#map-view"  id="map-view" class="last">Map</a>
            </div>
        </div>
        <div class="search-result-content">

            <?= $this->element('result-sidebar'); ?>
...
<script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.viewbox').colorbox({innerWidth:1000, innerHeight:1600, iframe:true});
