...
<div class="left">
    <?php $find_rentals_params = array('controller' => 'searches', 'action' => 'results'); ?>
  <?php echo $this->Html->image('blue-back-arr.png', array('width' => '7', 'height' => '13', 'class' => 'vm')); ?>
&nbsp;<?php echo $this->Html->link('Back to Search', $find_rentals_params); ?>
					...
					<div class="ss-slider-cnt">
						<div class="equal-col left">
							<div class="row">
								...
								<!-- this is what causes our undefined HTML DIV element errors -->
								<!--  div class="slider-range-Bed slip"></div -->
							</div>
							<div class="row">
								<label class="left-label"><?php echo __('Square Feet'); ?></label>
...
// hide saved searches until they are clicked
...
<?php echo $this->Html->script('savesearch.js'); ?>
