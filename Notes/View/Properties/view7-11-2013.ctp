...
<div class="productlanding-page">
	<div class="productpage-header">
		<div class="left">
			<?php
			echo $this->Html->link(
					$this->Html->image('blue-back-arr.png', array('width' => '7', 'height' => '13', 'class' => 'vm')).' <strong>'.__("Back to Search").'</strong>',
					array('controller' => 'searches', 'action' => 'results'),
					array('escape' => false)
				);
			?>
		</div>
		...
		<div class="product-content">
			<div class="product-tabs" id="ddpagetabs">
				<ul>
					...
					<li>
						<?php
						if ( ! empty($pr['area_latitude']) && ! empty($pr['area_longitude']) && ! empty($pr['area_radius'])) {
							echo $this->Html->link(
				...
				<?php
					...
					if ( ! empty($_SESSION['Auth']['User']['id'])) {
						...
						if (in_array($property['Property']['id'], $wishlisted_ids)) {
							...
							$url = array('controller' => 'wishlists', 'action' => 'add_wishlist', $property['Property']['id']);
							$class[] = 'thickbox';
						}
					}
			...
			<div class="product-tab-data">
				<div id="sc1">
					<div class="padder product-photos relative">
						...
						<?php
							if ( ! empty($property['PropertyImage'][0]['image']['main'])) {
				...
				<div id="sc3" class="tab-content">
					...
					<div class="discount-row">
						...
						<?php endif; ?>
							<li style="float: right;padding: 5px 10px;"><?php echo $this->Html->link(__('EMAIL HOST'), array('controller' => 'properties', 'action' => 'contact_me', $property['Property']['id'], '?' => 'width=485&height=600'), array('class' => 'pink-btn thickbox cal_update')); ?></li>
