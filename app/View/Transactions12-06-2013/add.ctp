...
<?php
		...
		<div class="input number required"><label for="TransactionAmount"> SSS Amount</label><input name="data[Transaction][amount]" step="any" type="text" id="TransactionAmount" required="required"/>
		</div>
			<?php		
